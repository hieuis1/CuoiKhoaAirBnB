              ...
              <div class="col-12 col-md-6 col-lg-3">
                ...
                <div class="kilimanjaro_part m-top-15">
                  ...
                  <ul class="kilimanjaro_links">
                    ...
                    <li>
                      <a href="#">
                        <i class="fa fa-angle-right" aria-hidden="true"></i>Help
                        & Support
                      </a>
                    </li>
                    <li>
              ...
              <div class="col-12 col-md-6 col-lg-3">
                ...
                <div class="kilimanjaro_part">
                  ...
                  <div class="kilimanjaro_works">
                    ...
                    <a class="kilimanjaro_works_img" href="img/gallery/4.jpg">
                      <img src="img/gallery/4.jpg" alt="" />
                    </a>
                    <a class="kilimanjaro_works_img" href="img/gallery/5.jpg">
                      <img src="img/gallery/5.jpg" alt="" />
                    </a>
                    <a class="kilimanjaro_works_img" href="img/gallery/7.jpg">
                      <img src="img/gallery/7.jpg" alt="" />
                    </a>
                    <a class="kilimanjaro_works_img" href="img/gallery/10.jpg">
                      <img src="img/gallery/10.jpg" alt="" />
                    </a>
                    <a class="kilimanjaro_works_img" href="img/gallery/11.jpg">
